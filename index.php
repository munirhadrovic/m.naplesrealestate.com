...
<html>
	<head>
		...
		<title>Naples Real Estate, Naples Florida homes for sale, and Naples Florida real estate for Naples and Southwest Florida.</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://naplesrealestate.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-user ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">About Us</a></div>
				</div>    
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-star ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Our Team</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-video ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Video Tour of Naples</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-comment ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Naples Real Estate Blog</a></div>
				</div>				        				
		
		  </div>
		  <h2>Welcome to NaplesRealEstate.com!</h2>
            <p>Naples source for searching 1000’s of listings.  2nd homes and condos, 1031 exchanges, luxury properties, relocation services, waterfront homes and condos, annual and seasonal rental, 
            Naples real estate investment opportunities, golf course and gated communities.</p>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Video Tour of Naples</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Naples Real Estate Blog</a></li>
